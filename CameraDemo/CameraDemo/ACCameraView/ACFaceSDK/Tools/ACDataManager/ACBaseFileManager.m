...
@implementation ACBaseFileManager
...
{
    return [[ACBaseFileManager pathForApplicationSupportDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[ACBaseFileManager pathForCachesDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[ACBaseFileManager pathForDocumentsDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[ACBaseFileManager pathForLibraryDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[ACBaseFileManager pathForMainBundleDirectory] stringByAppendingPathComponent:path];
}
...
{
    return [[ACBaseFileManager pathForTemporaryDirectory] stringByAppendingPathComponent:path];
}
