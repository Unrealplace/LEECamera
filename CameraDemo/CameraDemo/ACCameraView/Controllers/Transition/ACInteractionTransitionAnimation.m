//
//  ACInteractionTransitionAnimation.m
//  CameraDemo
//
...
#import "ACInteractionTransitionAnimation.h"
@interface ACInteractionTransitionAnimation ()
@property (assign , nonatomic) BOOL canReceive;

@property (strong, nonatomic) UIViewController * remVc;
@end
@implementation ACInteractionTransitionAnimation
